    ...
    <form name="add_name" id="add_name">  
      <div class="table-responsive" id="add_name">  
         <table class="table table-bordered" id="dynamic_field">  
            <tr>  
               <td><button type="button" name="add" id="add" class="btn btn-success">Add Slot</button></td>  
               <td><input type="text" name="name[]" placeholder="Enter ONID" class="form-control name_list" /></td>  
            </tr>  
         </table>  
         <input type="hidden" name="creatorID" id="creatorID" value="<?php echo $user->id;?>" /> 
